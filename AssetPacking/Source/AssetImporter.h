...
public:
	...
	bool AddResource(const std::filesystem::path& inputPath) override;
	void PackAllResources(const std::filesystem::path& inputPath, const std::filesystem::path& outputPath) override {}
private:
