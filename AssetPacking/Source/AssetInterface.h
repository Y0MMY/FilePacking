...
public:
	...
	virtual void AddResource(const std::filesystem::path& inputPath) = 0;
	virtual void PackAllResourñes(const std::filesystem::path& inputPath, const std::filesystem::path& outputPath) = 0;
